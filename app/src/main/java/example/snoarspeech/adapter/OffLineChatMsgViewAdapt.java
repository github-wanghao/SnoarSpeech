...
public class OffLineChatMsgViewAdapt extends BaseAdapter {
    int backgroundColor = Color.parseColor("#1E88E5");
    private ArrayList<OfflineSpeechAction.SiriListItem> list;
    private Context ctx;
    private LayoutInflater mInflater;
    private boolean isnet;
    IsNetWorkConnected isNetWorkConnected = new IsNetWorkConnected();

    public OffLineChatMsgViewAdapt(Context context, ArrayList<OfflineSpeechAction.SiriListItem> l) {
        ctx = context;
        list = l;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        OfflineSpeechAction.SiriListItem item=list.get(position);
